...
namespace Api.Auth
{
    public interface IAuthApi
    {
        ...
        public record Session(string jwtToken);
        ...
        public record SignInCredentials(string userEmail, string password, string passwordConfirmed, string role);
        ...
        Task<string> SignInAsync(SignInCredentials credentials);
        const string SIGNIN_PATH = "signin";
